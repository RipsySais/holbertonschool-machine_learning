#!/usr/bin/env python3
"""Module that defines the Isolation_Random_Tree class."""
...
class Isolation_Random_Tree():
    """Represents an isolation random tree, used to detect outliers."""

    def __init__(self, max_depth=10, seed=0, root=None):
        """Initialize the Isolation_Random_Tree with its hyperparameters."""
    ...
    def get_leaf_child(self, node, sub_population):
        """Create a Leaf child whose value is its own depth."""
    ...
    def fit(self, explanatory, verbose=0):
        """Train the isolation tree on the given explanatory data."""

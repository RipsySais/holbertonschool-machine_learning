...
def all_in_one():
    """Plots all 5 previous graphs in a single 3x2 figure"""
    y0 = np.arange(0, 11) ** 3
    ...
    # Graph 1: y0 as a line
    ax0 = plt.subplot2grid((3, 2), (0, 0))
    ax0.plot(y0, 'r-')
    ax0.set_xlim(0, 10)
    ax0.set_title('', fontsize='x-small')
    ...
    title3 = 'Exponential Decay of Radioactive Elements'
    ax3.set_title(title3, fontsize='x-small')
    # Graph 5: histogram (takes 2 columns)
